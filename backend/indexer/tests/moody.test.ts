...
import { handleMoodUploaded } from "../src/moody"
import { createMoodUploadedEvent } from "./moody-utils"
...
describe("Describe entity assertions", () => {
  beforeAll(() => {
    ...
    let newMoodUploadedEvent = createMoodUploadedEvent(
      id,
      hash,
      message,
      category,
    ...
    handleMoodUploaded(newMoodUploadedEvent)
  })
